        ...
        child: Column(
          children: [
            ReusableTextField(
              ...
              textInputType: TextInputType.phone, // type correct pour numéro
              validator: (value) => FormValidator.validateFieldNotEmpty(value, "Field"),
            ),
            ReusableTextField(
              controller: passwordController,
              hintText: "Password",
              obscureText: true,
              validator: (value) => FormValidator.validateFieldNotEmpty(value, "Password"),
            ),
            CustomRoundedButtom(
              title: "Sign In",
              onPressed: () {
