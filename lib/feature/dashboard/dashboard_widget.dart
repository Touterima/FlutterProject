//lib/feature/dashboard/dashboard_widget.dart
...
import 'package:ridesharing/feature/dashboard/trips/trips_list_widget.dart';
...
class _DashboardWidgetState extends State<DashboardWidget> {
  ...
  List pages = [
    ...
    const TripsListWidget(), // Remplacer Favourite par Trips
    const WalletWidget(),
    const OfferWidget(),
    const ProfileWidget(),
  ];
      ...
      bottomSheet: Container(
        ...
        child: BottomNavigationBar(
          ...
          items: <BottomNavigationBarItem>[
            ...
            BottomNavigationBarItem(
              icon: Icon(
                _selectedIndex == 1 ? Icons.directions_car : Icons.directions_car_outlined,
